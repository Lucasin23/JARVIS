...
def get_default_config() -> Dict[str, Any]:
    ...
    return {
        ...
        # Wake Word Detection
        "wake_word": "jarvis",
        "wake_aliases": ["jorvis", "joris", "charis", "chavis", "jar is", "jaivis", "jervis", "jarvus", "jarviz", "javis", "jairus", "jarryst", "chyrus"],
...
def load_settings() -> Settings:
    ...
    whisper_min_confidence = float(merged.get("whisper_min_confidence", 0.1))
